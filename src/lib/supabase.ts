...
/**
 * Client Supabase — typé après le Sprint 3 via :
 *   npx supabase gen types typescript --linked > src/types/database.ts
 * Pour l'instant, le typage strict est désactivé pour permettre les opérations
 * sur toutes les tables (kyc_documents, profiles update, etc.).
 */
